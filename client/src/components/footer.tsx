        ...
        <footer>
            ...
            <div className="flex flex-col mb-8 space-y-2 justify-center items-center t-primary ani-show">
                ...
                <p className='text-sm text-neutral-500 font-normal link-line text-center'>
                    <a className='hover:underline' href="https://icp.gov.moe/?keyword=20245001" target="_blank">
                        <img className="w-[16px] h-[16px]" src="https://icp.gov.moe/images/ico64.png"/>萌ICP备20245001号
                    </a>
                    <br/>
                    <span>
