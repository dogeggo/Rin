    ...
    return (
        <footer>
            ...
            <div className="flex flex-col mb-8 space-y-2 justify-center items-center t-primary ani-show">
                <div className="w-fit-content space-x-6 inline-flex rounded-full border border-zinc-200 p-[5px] dark:border-zinc-700">
                ...
                <p className='text-sm text-neutral-500 font-normal link-line text-center'>
                    <img className="h-[16px] h-[16px]" src="https://icp.gov.moe/images/ico64.png"></img>
